...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center(data-aos="zoom-in-rigth").azulbebe.p-4
      .col-lg-7
        h3 Pasos del patronaje – Implementación de básicos y desarrollo de modelos
        .row(data-aos="zoom-in-rigth").p-4
          .col-lg-7
            p 1. Básicos
            hr 
            p 2. Interpretación
    ...
    p En el siguiente video se presenta una explicación sobre la manera de realizar un patrón a escala: 
    .py-2
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/m2Fs4_FwmoE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .row.mb-5
      .col-lg-7
        ul.lista-ul.mb-4
          ...
          li
            i.fas.fa-atom
            | <b>Base inferior de falda</b>
          li
            i.fas.fa-atom
            | <b>Base inferior de pantalón</b>
    ...
    .d-flex.align-items-center.mt-5.mb-3(data-aos="zoom-in-left")
      img.w-card-icon(src="@/assets/curso/temas/icon-title.svg")
      h3.py-2.w-card-text 2. Interpretación:
    ...
    .d-flex.align-items-center.mt-5.mb-3(data-aos="zoom-in-left")
      img.w-card-icon(src="@/assets/curso/temas/icon-title.svg")
      h3.py-2.w-card-text 4.	Señalización: 
    ...
    .d-flex.align-items-center.mt-5.mb-3(data-aos="zoom-in-left")
      img.w-card-icon(src="@/assets/curso/temas/icon-title.svg")
      h3.py-2.w-card-text 5.	Despiece:
    ...
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/zilfDUXi62E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Leyenda del video
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-4
        .titulo-sexto.color-acento-contenido
          h5 Figura 12.
          span Transformación de sisas y mangas
        img(src='@/assets/curso/temas/tema1/img16.svg', alt='')
        caption.text-small Fuente: Manual_patronaje_basico_interpretacion_disenos.PDF - SENA
    ...
    .row.justify-content-center(data-aos="fade-left")
      ...
      .col-md-4.mb-3.mb-md-0.p-4
        .titulo-sexto.color-acento-contenido
          h5 Figura 14.
          span Cabeza de manga
        img(src='@/assets/curso/temas/tema1/img19.svg', alt='En el lado izquierdo, hay un cuadro color crema con texto que parece ser parte de una instrucción o definición sobre tipos de mangas en costura. Enumera tres tipos de “Cabeza de manga” con fórmulas matemáticas para su construcción: “Cabeza de manga deportiva = sisa delantera + sisa posterior / 5” “Cabeza de manga casual = sisa delantera + sisa posterior / 4” “Cabeza de manga sastre o formal = sisa delantera + sisa posterior / 3” En el lado derecho, hay un gráfico con una regla vertical que indica el “Largo de manga”. Hay tres líneas horizontales de colores que señalan diferentes longitudes para tipos de manga: “Deportivo”, “Casual” y “Formal o Sastre”. A la izquierda de la regla, las letras “D” y “P” podrían referirse a las medidas de largo para los tipos de manga respectivos.')  
    .py-2
    ...
    .row.justify-content-center(data-aos="fade-left")
      .col-lg-4.col-8.col-sm-8.p-4.cajonlila
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-center.align-items-center
                ...
                .col-sm-auto
                  a.boton.color-primario.texto-blanco(:href="obtenerLink('/https://youtu.be/eE3D_mjMC2Q')" target="_blank")
                    span Ir al sitio
                    i.fas.fa-video
          
    .d-flex.align-items-center.mt-5.mb-3(data-aos="zoom-in-left")
      img.w-card-icon(src="@/assets/curso/temas/icon-title.svg")
      h3.py-2.w-card-text Modificaciones de manga
    ...
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/x_262TA1srw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Leyenda del video
    ...
    .d-flex.align-items-center.mt-5.mb-3(data-aos="zoom-in-left")
      img.w-card-icon(src="@/assets/curso/temas/icon-title.svg")
      h3.py-2.w-card-text 02. Los cuellos por unión de hombro 
    ...
    p En el siguiente video se describe la manera de realizar trazos de los diferentes tipos de cuellos:
    .py-1
    figure.mb-5(data-aos="zoom-in-left")
      .video
    ...
    .row.justify-content-center.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-lg-12
        .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5
          ...
          .bloque-texto-g__texto.p-4.d-flex.flex-column
            ul.lista-ul--color.lista-ul--separador.p-4
              li 
                i.fas.fa-atom
    ...
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/u0eiVcJAldI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Leyenda del video 
    .py-2
    ...
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/X4LLIHW3dLo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Leyenda del video 
    ...
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/2LKkxEJnRj8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Leyenda del video 
    ...
    .d-flex.align-items-center.mt-5.mb-3(data-aos="zoom-in-left")
      img.w-card-icon(src="@/assets/curso/temas/icon-title.svg")
      h3.py-2.w-card-text Bolsillo
    p Dentro del desarrollo de pantalón se encontrarán especificaciones como partes que conforman un bolsillo, como se presenta en la siguiente imagen: 
    .py-2
    ...
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/oBsuCQmODcc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Leyenda del video 
    ...
    .row.justify-content-center(data-aos="fade-left")
      .col-lg-8
        .titulo-sexto.color-acento-contenido
          h5 Figura 33.
          span Overol
        img(src='@/assets/curso/temas/tema1/img46.png', alt='Fotografía de una niña luciendo un overol verde, se presentan ambos lados, delantero y posterior.')
    ...
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/Zawo0ddvcas" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Leyenda del video 
