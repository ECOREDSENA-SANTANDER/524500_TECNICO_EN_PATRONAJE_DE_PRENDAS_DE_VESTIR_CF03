  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Patronaje básico línea masculina
    
    .fondo-azul.p-4
      .row.justify-content-center.align-items-center(data-aos="fade-left").py-4
        .col-lg-8
          p Antes de iniciar la implementación y transformación de básicos en masculino #[b se debe tener en cuenta la introducción y los conceptos referenciados en la unidad de pre-patronaje], con el fin de mantener claridad en el desarrollo de modelos.
          p Lo primero para tener en cuenta es el #[b manejo de cuadro de tallas y unidad de medida], en masculino el desarrollo de modelos o diseños en el manual se identifica en centímetros; sin embargo, el cuadro de tallas se encuentra en pulgadas, #[b es necesario tener el cuadro de tallas con la conversión] a centímetros para facilitar los procesos del trazo.
        .col-lg-4.col-8
    ...
    #t_2_1.titulo-segundo.color-primario
      h2 2.1 Trazo de camisa clásica
    ...
    p El video a continuación describe la manera de realizar el trazo de camisa clásica, teniendo en cuenta el manual de patronaje: 
    ...
    .d-flex.align-items-center.mt-5.mb-3(data-aos="zoom-in-left")
      img.w-card-icon(src="@/assets/curso/temas/icon-title.svg")
      h3.py-2.w-card-text Camisa #[em slim fit]
    ...
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/3RWdObxnOYY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Leyenda del video 

    .d-flex.align-items-center.mt-5.mb-3(data-aos="zoom-in-left")
      img.w-card-icon(src="@/assets/curso/temas/icon-title.svg")
      h3.py-2.w-card-text Trazo de manga, puño y cuello – camisa clásica y #[em slim fit]
    ...
    .row.justify-content-center.mb-5
      .col-lg-9
        p Dentro de los ejercicios anteriores de cabezas de manga se identifica la generalidad de cabeza de manga deducida como:
        ...
        .tarjeta-avatar-b.mb-5
          ...
          .tarjeta.bglila
            .p-4
              ...
              h5 Cabeza de manga casual = sisa delantera + sisa posterior / 4
        ...
        .tarjeta-avatar-b.mb-5
          ...
          .tarjeta.bglila
            .p-4
              ...
              h5 Cabeza de manga camisa slim fit = sisa delantera + sisa posterior / 6+4
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-8
